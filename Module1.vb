...
Module Module1
    ...
    Public Sub importToExcel(ByVal grdData As DataGridView, ByVal templatefilename As String)
        ...
        For x = 0 To grdData.RowCount - 1
            For y = 0 To grdData.ColumnCount - 1
                xlsSheet.Cells(x + 7, y + 1) = grdData.Rows(x).Cells(y).Value
            Next
        Next
        With xlsSheet.Range(convertToLetters(1) & 7, convertToLetters(grdData.ColumnCount) & x + 6)
